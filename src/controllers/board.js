...
export default class BoardController {
  ...
  render(tasks) {
    ...
    const newTasks = renderTasks(taskListElement, this._tasks
      .slice(0, this._showingTasksCount), this._onDataChange, this._onViewChange);
  ...
  _onDataChange(taskController, oldData, newData) {
    ...
    this._tasks = this._tasks.slice(0, index).concat(newData, this._tasks.slice(index + 1));
